...
public class ResponseProcessingHandler extends AbstractConnector {
    ...
    public void connect(MessageContext messageContext) throws ConnectException {
        ...
        if (messageContext instanceof Axis2MessageContext) {
            ...
            String clientId = (String) messageContext.getProperty(Constants.CERNER_PROPERTY_CLIENT_ID);
            String tokenEP = (String) messageContext.getProperty(Constants.CERNER_PROPERTY_TOKEN_ENDPOINT);
